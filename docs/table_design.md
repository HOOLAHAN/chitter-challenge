# Two Tables Design Recipe Template - Chitter-Challenge
...
```
Nouns:
peep, time, date, content, user, email, password, name, username
```
...
| Record                | Properties          |
| --------------------- | ------------------  |
| peep                  | timestamp, content, user_id
| user                  | email, password, name, username, 

1. Name of the first table (always plural): `peeps` 

    Column names: `timestamp, content, user_id`
